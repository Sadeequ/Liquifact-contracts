...
fn test_token_integration_assumptions_are_documented_in_readme() {
    ...
    assert!(contents.contains("fee-on-transfer"), "Expected unsupported token warning to be documented");
    assert!(contents.contains("smallest units"), "Expected smallest-unit assumption to be documented");
}
